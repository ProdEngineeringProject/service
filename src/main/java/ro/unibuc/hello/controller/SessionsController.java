...
public class SessionsController {
    ...
    @Counted(value = "auctions.sessions.login.count", description = "Times login handled")
    ...
    @Counted(value = "auctions.sessions.logout.count", description = "Times logout handled")
